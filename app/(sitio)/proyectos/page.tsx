...
export const metadata: Metadata = {
  ...
  description:
    'Galería de proyectos realizados por SAC: viviendas, edificios e instituciones construidas con precisión técnica en Chile. Más de 30 años de experiencia.',
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="font-display text-3xl text-gray-900">
              Más de 30 años construyendo en Chile
            </h2>
