          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-display text-3xl text-gray-900 mt-3 mb-6">
                Más de 30 años construyendo confianza
              </h2>
            ...
            <div className="bg-brand-gray-light aspect-[4/3] overflow-hidden border border-brand-gray-mid">
              <Image
                src="/equipo.png"
                alt="Equipo de trabajo - Empresa SAC Ltda."
                width={800}
                height={600}
